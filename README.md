[![CI Status](https://github.com/turansky/cesium-kotlin/workflows/declarations/badge.svg)](https://github.com/turansky/cesium-kotlin/actions)
...
```kotlin
dependencies {
    implementation("com.github.turansky.cesium:cesium-kotlin:1.83.0-10")
}
```
